...
export interface GenerationVersion { id:string; generation_id:string; version:number; asset_id:string|null; approved:boolean; favorite:boolean; notes:string; provider_request_id:string|null; metadata:Record<string,unknown>; created_at:string }
